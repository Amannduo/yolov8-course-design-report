...
| 技术 | 掌握程度 | 主要应用 | 学习收获 |
|------|---------|---------|---------|
| PyTorch框架 | 基础掌握 | 模型加载、推理执行 | 了解了深度学习模型的基本使用 |
| YOLOv8模型 | 基础使用 | 目标检测、结果可视化 | 第一次接触YOLO系列模型，感觉很有趣 |
| 模型推理 | 初步了解 | 参数调整、结果处理 | 学会了基本的推理流程和参数设置 |

#### **Web开发技术**

| 技术 | 掌握程度 | 主要功能 | 学习收获 |
|------|---------|---------|---------|
| Flask框架 | 基础掌握 | 路由设计、请求处理、错误处理 | 从Hello World开始学会了Web框架的基本使用 |
| API设计 | 初步了解 | 统一接口、JSON响应、错误处理 | 了解了前后端交互的基本方法 |
| 前端技术 | 基础使用 | HTML5、CSS3、JavaScript | 实现了简单的文件上传界面 |

#### **系统部署技术**

| 技术 | 掌握程度 | 操作内容 | 学习收获 |
|------|---------|---------|---------|
| Ubuntu系统 | 基础操作 | 环境配置、包管理、服务运行 | 提升了Linux系统的基本操作能力 |
| VMware虚拟化 | 基础使用 | 虚拟机创建、网络配置 | 学会了虚拟化环境的基本管理 |
| 网络配置 | 问题解决 | localhost vs IP、代理设置 | 解决了跨平台网络访问的实际问题 |
...
**技术优点**：通过 单例模式 + 线程锁，让所有线程/请求共享一个 YOLO 模型对象，既节省资源、提升响应速度，又避免多线程并发加载带来的错误。
